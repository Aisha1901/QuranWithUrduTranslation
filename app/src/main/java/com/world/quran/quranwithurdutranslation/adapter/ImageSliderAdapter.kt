...
internal class ImageSliderAdapter(context: Context, images: IntArray) : PagerAdapter() {
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        val imageView: ImageView = itemView.findViewById(R.id.slider_img_item) as ImageView
